...
(*
  ============================================================================
  Developer-only Diagnostics: optional consistency / nontriviality checks
  - Not part of the main argument body.
  - Safe to remove for release; used only for Nitpick model probes and audits.
  - Duplicates removed and consolidated from prior scratch snippets.
  ============================================================================
*)
...
All text and labels are in English for portability.\<close>
...
section \<open>8. Computational Diagnostics and Model Existence (Nitpick test)\<close>
text \<open>
